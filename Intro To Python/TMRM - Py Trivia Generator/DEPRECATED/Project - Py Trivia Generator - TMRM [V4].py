...
while int(questNum) < int(amount):
      ...
      def start_quiz():
          ...
          payload = {'amount' : amount, 'category' : cat, 'difficulty' : diff, 'type' : 'multiple'}
          ...
          print (quiz[amount-1]['category'])
          #Print the First Question Generated
          print (quiz[amount-1]['question'])
          ...
          print ("---------------------------------------------------------")
          answer_list = [(quiz[amount-1]['correct_answer']), (quiz[amount-1]['incorrect_answers'][0]), (quiz[amount-1]['incorrect_answers'][1]), (quiz[amount-1]['incorrect_answers'][2])]
          #randomly arrange answers
          random.shuffle(answer_list)
          print (answer_list)
          #Question Display:
          global lb4
          lb4 = tk.Label(window, text=  quiz[amount-1]['question'])        
      ...
      def checked():
          ...
          if selection == str(quiz[amount-1]['correct_answer']):
